...
<body>
	...
	if (user != null || pass != null) 
	{
		...
		if (rs.size() > 0) {
			response.sendRedirect("Dashboard.jsp?username=" + URLEncoder.encode(rs.get(0).getUsername(), "UTF-8") + "&userid="
			+ URLEncoder.encode(String.valueOf(rs.get(0).getId()), "UTF-8"));// Retrieve data from the query parameters
